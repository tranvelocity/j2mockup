/*
  ...
  JienieLayout.init() se:
    ...
    - Gan dropdown user (profile/logout), notice bell (cuon toi #Notification neu co
      tren trang, neu khong co se dieu huong sang eProcurement_Home.html#Notification).
  ...
  var SIDEBAR_HTML = `<aside id="wrapper-sidebar">
    ...
    <ul>
      <li class="nav-group">
        ...
        <ul class="submenu">
          <li><a href="eProcurement_Requester_EstimateApplicationApplicantList.html">見積依頼・見積回答</a></li>
          <li><a href="eProcurement_Requester_All.html">すべて</a></li>
    ...
    if (noticeBtn) {
      noticeBtn.addEventListener('click', function () {
        ...
        if (target) {
          ...
          window.location.href = 'eProcurement_Home.html#Notification';
        }
      });
    }
  }
